...
func (ec *Client) SendRawTransactionByHash(ctx context.Context, rawhash string) (common.Hash, error) {
	var txHash common.Hash
	err := ec.RpcClient.CallContext(ctx, &txHash, "eth_sendRawTransaction", rawhash)
	return txHash, err
}
